    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-xl p-8 shadow-2xl">
        ...
        <div className="mt-6">
          ...
          <select className="w-full px-4 py-3 border-2 border-slate-200 focus:border-slate-900 outline-none transition-all">
...
function DocumentPreviewModal({ document, onClose }: { document: Document; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl">
        {/* Header */}
